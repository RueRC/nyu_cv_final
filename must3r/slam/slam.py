...
def main():
    ...
    if num_images < 2:
        raise ValueError(f"❌ Not enough images in {image_dir} (found {num_images}).")

    if num_images <= 500:
        args.skip_every = 1
    elif num_images <= 1000:
        args.skip_every = 2
    elif num_images <= 1500:
        args.skip_every = 3
    ...
    print(f"📷 Found {num_images} images → setting skip_every = {args.skip_every}")
